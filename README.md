### Hi there, I'm Samarth Narula aka Tech Architect | Cloud Architect | Full Stack Developer | Udemy Publisher with more than 40k Enrollments from all around the Globe | Coursera Publisher | TutorialsPoint Publisher | Eduonix Publisher | AWS Solution Architect Professional Certified | Microservice Architect | In Collaboration with Great Learning, MicroStreams, Techmentry | Principal Software Engineer at Atlan | ex-Here Technologies | ex-Oracle, ex-Accenture(Worked for Goldman Sachs & MasterCard Client)  👋

Things that I do on daily basis

- 🔭 I’m currently working on AWS, DevOps, JAVA, Spring Boot, Scala, Gitlab CICD, Flink
